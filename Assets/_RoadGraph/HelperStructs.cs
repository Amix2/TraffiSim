...
public struct RoadNodeEnt : IEquatable<RoadNodeEnt>, IEquatable<Entity>
{
    ...
    public override readonly bool Equals(object obj) => obj is RoadNodeEnt o && Ent == o.Ent;

    public override readonly int GetHashCode() => Ent.GetHashCode();

    public override readonly string ToString() => $"RoadNode({Ent.Index}:{Ent.Version})";
...
public struct RoadSegmentEnt : IEquatable<RoadSegmentEnt>, IEquatable<Entity>
{
    ...
    public override readonly bool Equals(object obj) => obj is RoadSegmentEnt o && Ent == o.Ent;

    public override readonly int GetHashCode() => Ent.GetHashCode();

    public override readonly string ToString() => $"RoadSegment({Ent.Index}:{Ent.Version})";
...
public struct RoadPortEnt : IEquatable<RoadPortEnt>, IEquatable<Entity>
{
    ...
    public override readonly bool Equals(object obj) => obj is RoadPortEnt o && Ent == o.Ent;

    public override readonly int GetHashCode() => Ent.GetHashCode();

    public override readonly string ToString() => $"RoadPort({Ent.Index}:{Ent.Version})";
...
public struct RoadLaneEnt : IEquatable<RoadLaneEnt>, IEquatable<Entity>
{
    ...
    public override readonly bool Equals(object obj) => obj is RoadLaneEnt o && Ent == o.Ent;

    public override readonly int GetHashCode() => Ent.GetHashCode();

    public override readonly string ToString() => $"RoadLane({Ent.Index}:{Ent.Version})";
