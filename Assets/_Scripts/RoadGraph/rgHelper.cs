...
{
    public static Entity SpawnNodeOLD(EntityCommandBuffer ecb, Entity prefab, float3 position, Entity RoadManagerEnt)
    {
    ...
    public static Entity SpawnRoad(EntityManager manager, EntityCommandBuffer ecb, Entity StartNode, Entity EndNode, Entity RoadManagerEnt)
    {
        NativeList<ComponentType> types = new(4, Allocator.Temp)
        {
            ComponentType.ReadOnly<rgEdge>(),
